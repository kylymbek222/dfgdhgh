...
const StudentsByCoursesAndGroups = (props) => {
    ...
    return <div className="container-fluid">
        <div className="row align-items-end justify-content-center">
            ...
            <div className="col-md-2 col-lg-2">
                <button type="button" className="btn btn-primary" onClick={showStudent}>Найти</button>
            </div>
        </div>
...
export default connect(mapStateToProps, {getStudentsTC})(StudentsByCoursesAndGroups)
